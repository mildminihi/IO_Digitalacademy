...
class Constants {
    ...
    static let mostDoExamServiceUrl = "http://192.168.110.146:8085/api/exam/exam_most"
    ...
    static let loginServiceUrl = "http://192.168.110.198:8083/api/auth"
    static let refreshTokenServiceUrl = "http://192.168.110.198:8083/api/auth/regen"
